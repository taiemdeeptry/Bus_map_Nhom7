...
//    Đổ data vào notification adapter
    ...
    private List<Notification> getNotifications() {
        ...
        notifications.add(new Notification(
                ...
                "Thông báo kế hoạch hoạt động của các tuyến xe buýt vào dịp lễ Giáng Sinh và Tết Dương lịch 2026",
                Support.stringToDate("21/5/2025 15:25", "dd/MM/yyyy HH:mm"),
                R.drawable.sun,
                R.layout.notification_detail_3));
        notifications.add(new Notification(
                "Tạm điều chỉnh lộ trình tuyến",
                "Ngày 15/05/2025, tạm thời điều chỉnh lộ trình các tuyến xe buýt qua khu vực đường Lý Thái Tổ thành phố Đồng Hới. Xem chi tiết thêm!",
                Support.stringToDate("10/05/2025 20:31", "dd/MM/yyyy HH:mm"),
                R.drawable.fireworks,
                R.layout.notification_detail_2));
        notifications.add(new Notification(
                "Khôi phục hoạt động 15 tuyến xe buýt",
                "Từ 1/4, TP.HCM khôi phục hoạt động thêm 15 tuyến buýt. Xem thêm chi tiết!",
                Support.stringToDate("25/03/2025 08:33", "dd/MM/yyyy HH:mm"),
